...
import es.um.redes.nanoGames.games.NGRoomChainedWords;
import es.um.redes.nanoGames.games.NGRoomChainedWordsWithoutTurns;
...
public class NanoGameServer implements Runnable {
    ...
    private NanoGameServer(InetSocketAddress address) {
    	...
    	manager.registerRoomManager(new NGRoomChainedWords(4, 2, 60));
    	manager.registerRoomManager(new NGRoomChainedWordsWithoutTurns(2, 2, 60));
    }
