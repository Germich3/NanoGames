...
public class NGCommands {
	...
	public static final byte COM_CHANGENICK = 4;
	public static final byte COM_ANSWER = 5;
	public static final byte COM_EXIT = 6;
	public static final byte COM_RULES = 7;
	public static final byte COM_STATUS = 8;
	public static final byte COM_QUIT = 99;
	public static final byte COM_HELP = 100;
	...
	private static final String[] _valid_user_commands_help = {
		...
		"to display the current <nickname>",
